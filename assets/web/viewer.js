...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = 'frame/pdf.worker.js';
...
var PDFViewerApplication = {
  ...
  open: function pdfViewOpen(file, args) {
    ...
    var pdfData = parent.document.getElementById('txtrealcontent').value; //localStorage.pdfbase64data;
...
window.print = function print() {
  //热敏纸打印
    // if(parent.document.getElementById('paperType').value==1) {
        $(parent.document.getElementById('thermal-paper')).jqprint({operaSupport: true});
        return;
    // }
  if (activeService) {
...
//var DEFAULT_URL = 'https://zhanwill.blob.core.chinacloudapi.cn/coverprint/1506675267289.pdf'
;
var pdfjsWebApp;
{
...
/******/ ]);
// var pdf_data=false;
// pdf_data=localStorage.pdfbase64data;
// pdf_data=pdf_data.replace('data:application/pdf;base64,', '');
// pdf_data=atob(pdf_data);
