...
define(['api', 'global', 'data'], function (Api, Global, Data) {
    return {
        ...
        run: function () {
            ...
            //初始化面包屑
            Global.fun.updataCrumbs([{ lg: 'delivey-detail' }]);
            //初始化vue
            this.vue = new Vue({
                el: ".page-wrapper",
                data: {
                ...
                methods: {
                    ...
                    loadList: function () {
                        var that = this;
                        Api.set({ key: 'getShipppingDetailsList', type: 'GET', isToken: false, data: { pageNo: this.pagerObj.current, pageSize: this.pagerObj.pagesize } }, {
